...
class MysqlCon{
    ...
    static {
        try {
            con = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/pranav", "root", "pranav7302");
    ...
    public static Logger log = Logger.getLogger(MysqlCon.class.getName());
                        ...
                        switch (choice2) {
                            case 1: {
                                if(checkAvailable("permanentemployee",empDel)) {
                                    ...
                                    System.out.println("Employee ID not found in permanent employee list");
                                }
                            }
                            break;
                            case 2: {
                            ...
                            case 2: {
                                if(checkAvailable("parttimeemployee",empSearch)) {
                                   PartTimeEmployee.searchParttime(empSearch);
                                    ...
                                    System.out.println("Employee ID not found parttime employee list");
                                }
                            }
                            break;
                            case 3: {
